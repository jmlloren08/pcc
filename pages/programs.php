                    ...
                    <div class="navbar-collapse justify-content-md-center collapse" id="navbarNavAltMarkup">
                        <div class="navbar-nav">
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item p-2 zoom">
                                    <a class="nav-link" href="../pages/programs.php"><span
                                            class="fnt-clr">Programs</span></a>
                                </li>
                                <li class="nav-item p-2 zoom">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div
                            ...
                            <div class="copyright-left"><a href="#"><img src="../img/navbar/pcc_logo2.png"
                                        alt="pcc-logo" class="imgFooterLogo"></a>
